...
@Component
public class GetLoansByLibraryUseCase {
    private final LoanRepository loanRepository;
    private final AuthenticatedUserProvider authenticatedUserProvider;

    public GetLoansByLibraryUseCase(LoanRepository loanRepository, AuthenticatedUserProvider authenticatedUserProvider) {
    ...
    public List<LoanResult> get(UUID libraryId) {
        ...
        return loanRepository.findByLibraryId(libraryIdEntity)
                .stream()
                .map(this::toResult)
                .toList();
    }
